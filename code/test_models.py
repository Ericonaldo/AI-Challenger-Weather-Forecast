...
# 测试分数
obs_file = "../data/ai_challenger_wf2018_testb5_obs_2018110103.csv" # 观测结果
fore_file = "../data/ai_challenger_wf2018_testb5_fore_2018110103.csv" # 超算结果

# obs_file = "../data/ai_challenger_wf2018_testb4_obs_2018103103.csv" # 观测结果
# fore_file = "../data/ai_challenger_wf2018_testb4_fore_2018103103.csv" # 超算结果

# obs_file = "../data/ai_challenger_wf2018_testb3_obs_20181030.csv" # 观测结果
# fore_file = "../data/ai_challenger_wf2018_testb3_fore_20181030.csv" # 超算结果

# obs_file = "../data/ai_challenger_wf2018_testb2_obs_2018102903.csv" # 观测结果
# fore_file = "../data/ai_challenger_wf2018_testb2_fore_2018102903.csv" # 超算结果
...
def test_old_days_model_catlog2():
    from old_days_model_catlog2 import model_t2m_file,model_rh2m_file,model_w10m_file,exract_feature
    ...
    test_idx = df_processed[lambda x: x.station_date_time.str.split('_').apply(lambda x: x[1]) == prd_time.replace('-','').replace(' ','')].index
    df_test = df_processed.loc[test_idx]
    df_test.sort_values(['stations','dates','foretimes'], inplace=True)
    del df_processed
